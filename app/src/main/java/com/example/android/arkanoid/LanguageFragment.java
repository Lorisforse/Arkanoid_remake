...
public class LanguageFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        italian.getBackground().setAlpha(64);
        english.getBackground().setAlpha(64);
        spanish.getBackground().setAlpha(64);
        francais.getBackground().setAlpha(64);
        return v;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.italian:
                ...
                italian.getBackground().setAlpha(255);
                english.getBackground().setAlpha(64);
                spanish.getBackground().setAlpha(64);
                francais.getBackground().setAlpha(64);
            ...
            case R.id.english:
                setLocate("en");
                italian.getBackground().setAlpha(64);
                english.getBackground().setAlpha(255);
                spanish.getBackground().setAlpha(64);
                francais.getBackground().setAlpha(64);
                break;
            case R.id.spanish:
                ...
                italian.getBackground().setAlpha(64);
                english.getBackground().setAlpha(64);
                spanish.getBackground().setAlpha(255);
                francais.getBackground().setAlpha(64);
                break;
            case R.id.francais:
                setLocate("fr");
                ...
                english.getBackground().setAlpha(64);
                spanish.getBackground().setAlpha(64);
                francais.getBackground().setAlpha(255);
                break;
            case R.id.back:
            case R.id.close:
                setLocate("locale");
